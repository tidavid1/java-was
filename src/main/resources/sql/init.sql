...
INSERT INTO USERS (id, user_id, password, name, email)
SELECT 1, 'account', 'account', 'account', 'account@gmail.com'
WHERE NOT EXISTS(SELECT 1 FROM USERS WHERE user_id = 'account');

INSERT INTO ARTICLES (id, title, body, image_path, user_id, username)
SELECT 1,
       '리엑티브 시스템(Reactive System)',
